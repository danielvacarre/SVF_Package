...
class CSVFEff(EfficiencyMethod):
    """
        Clase para el cálculo de la eficiencia CSVF
    """
    def __init__(self, inputs, outputs, data, methods, df_estimation):
        """Constructor de la clase CSVFEff. Hereda de EfficiencyMethod
    ...
    def calculate_ruo(self):
        ...
        for obs in range(len(self.data)):
            ...
            # Número de observaciones del problema
            n_obs = len(Y)
            mdl = Model("CSVF OUTPUT ORIENTED RUSSELL")
            # Variables
            # Variable phi
    ...
    def calculate_erg(self):
        ...
        for obs in range(len(self.data)):
            ...
            mdl = Model("CSVF ENHANCED RUSSELL GRAPH")
            # Variables
